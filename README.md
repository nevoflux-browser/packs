...
| [`linkedin-to-pipeline`](linkedin-to-pipeline/) | `/linkedin-to-pipeline` | Runs LinkedIn as pipeline infrastructure — 8 skills for calendar planning (70/20/10 funnel over a rolling window), targeted story mining (nine lenses, four hard gates) across team and market sources, hook-first writing, a review gate, publishing handoff (no auto-posting), repurposing, and weekly review; backed by protected seed pages for your brand profile, idea sources, backlog, calendar, and review log. |
